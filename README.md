...
| File | Purpose |
| --- | --- |
| `shopping_list_prototype.py` | Python script modeling the five screens and eight navigation links |
...
| `shopping_screens.png` | Paper prototype: five screens with numbered navigation arrows |
| `README.md` / `README.txt` | This file |

## Architecture (Step 1)

![Component architecture diagram](shopping_architecture.png)
...
## Paper prototype (Step 2)

![Paper prototype: five screens with numbered navigation arrows](shopping_screens.png)
